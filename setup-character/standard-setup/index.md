...
![Setup Character_Standard.png](Setup_Character_Standard.png)

There are a total of **two Material Presets**:

1. ZLZ_Std_Char_Body — Used for all parts of the character
2. ZLZ_Std_Char_Face — Used exclusively for the character’s face
