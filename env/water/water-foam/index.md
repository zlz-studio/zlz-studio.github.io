...
เมื่อเปิด Flow และอยู่ในกรอบที่ Bake ไว้ กลุ่มฟองจะขึ้นได้ **เฉพาะในระยะราว 6–12 เมตรจากของที่โผล่พ้นผิวน้ำจริงๆ**
...
- **เปิด Flow แล้วมีการอ่านแผนที่เพิ่มทั่วผืนน้ำ 2 ครั้ง** (แผนที่ทิศทาง + นอยส์ที่ใช้กระจายจังหวะ) เพราะ Ring Wave ต้องใช้ข้อมูลนี้ในน้ำเปิดด้วย ส่วนการอ่านลายฟองที่ไหลอีก 2 ครั้ง เกิดเฉพาะในแถบที่มีฟองเท่านั้น
