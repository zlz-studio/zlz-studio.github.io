...
## สูตรที่ต้องเข้าใจก่อน

จุดที่ทำให้คนสับสนบ่อยที่สุดของฟีเจอร์นี้คือ **แสงที่เปล่งออกมาถูกคูณด้วยสีของเท็กซ์เจอร์เอง** ไม่ใช่การเอาสีทับลงไปเฉยๆ

```
แสงที่บวกเพิ่ม  =  สีเท็กซ์เจอร์ × มาสก์ × Emission Color × Emission Intensity
```

ผลที่ตามมามีสองข้อที่ต้องรู้ไว้ :

- **ส่วนที่เท็กซ์เจอร์เป็นสีดำสนิทจะไม่เปล่งแสงเลย** ไม่ว่าจะดัน Intensity สูงแค่ไหน เพราะอะไรก็ตามคูณกับศูนย์ก็ยังเป็นศูนย์ ถ้าอยากให้ตรงไหนเรืองแสง ตรงนั้นต้องมีสีในเท็กซ์เจอร์ก่อน
- **สีที่ได้คือสีเท็กซ์เจอร์ผสมกับ Emission Color** ตั้ง Emission Color เป็นขาว แล้วคริสตัลสีฟ้าจะเรืองเป็นสีฟ้าของตัวมันเอง ไม่ใช่ขาว

ถ้าอยากได้แสงสีที่ไม่เกี่ยวกับสีเท็กซ์เจอร์เลย ต้องทำให้บริเวณนั้นในเท็กซ์เจอร์เป็นสีขาว แล้วค่อยกำหนดสีที่ Emission Color

---

## Parameters

<!-- TODO: ใส่สกรีนช็อตหัวข้อ Emission เป็น Material_Emission.png -->
