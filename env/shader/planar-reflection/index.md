...
- **มีต้นทุนคือการวาดฉากอีกหนึ่งรอบ** — ยิ่งฉากหนัก รอบที่สองก็ยิ่งหนักตาม ด้วยเหตุนี้จึงควรตั้ง **Renderer Index** ไปที่ **`URP_Reflection`** ที่เตรียมมาให้ในแพ็กเกจ เพราะเป็น Renderer ที่ optimize มาเพื่อรอบที่สองนี้โดยเฉพาะ เบาพอที่จะใช้บน Mobile ได้
